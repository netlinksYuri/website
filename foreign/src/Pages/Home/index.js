              ...
              <div class="   ">
                <div class=" flex-row h-16 flex items-center justify-between sm:items-stretch sm:justify-between">
                  ...
                  <div class="flex  items-center justify-center sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <a
                      href="/#forms"
                      class=" text-sm btn-forms text-white py-2 px-8 font-medium"
                      aria-current="page"
                    >
                      Get in touch
                    </a>
                ...
                <div class="flex-1  items-center justify-center sm:hidden block ">
                  <div class="flex h-16 items-center justify-center nav ">
                    <a href="/nri/home" class=" font-bold px-2 py-2 text-xs ">
                      HOME
                    </a>
                    <a href="/nri/about" class="  font-bold px-2 py-2 text-xs ">
                      ABOUT
                    </a>
                    <a
                      href="/nri/products"
                      class="  font-bold px-2 py-2 text-xs "
                    >
                      PRODUCTS
                    </a>
                    <a
          ...
          <div className=" flex basis-7/12  items-center p-3 card">
            <div className="text-left">
              ...
              <div className="mt-4 flex">
                <a
                  href="/#forms"
                  class="btn-forms mt-4 py-2 px-5 text-gray-50 sm:block hidden "
                  aria-current="page"
                >
                  Get in touch
                </a>
          ...
          <div className=" flex flex-col basis-5/12  justify-center  ">
            <h5 className="border-l-2 cardw pl-5 py-5 ml-4 sm:ml-0 mt-5 font-normal  text-gray-50 ">
              ...
              <div className=" flex">
                <a
                  href="/#forms"
                  class="btn-forms mt-4 py-2 px-5 mr-70 sm:mr-0 text-gray-50 text-center sm:hidden block  "
                  aria-current="page"
                >
                  Get in touch
                </a>
            ...
            <div className="flex flex-col sm:flex-row justify-center  max-w-6xl mx-auto ">
              ...
              <div className=" flex flex-col basis-6/12  justify-center  ">
                ...
                <div className="my-12 ">
                  <a
                    href="#"
                    class="btn-forms mt-4 py-3 px-8 text-gray-50"
                    aria-current="page"
                  >
                    Download now
                  </a>
