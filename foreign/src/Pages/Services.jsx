 ...
 <div className="ss2 max-w-6xl mx-auto py-16">
        <div className="flex flex-row justify-between">
          ...
          <div className="flex  items-end" >
            <h5 className="  text-right capaapp">
        ...
        <div className="flex flex-row justify-between">
          <div className=" flex flex-col basis-6/12  mt-12 ">
            ...
            <div className="py-24 px-12  flex flex-col justify-center cardServ ">
              ...
              • Product details • Exchange fees simulation <br/>
...
environments)
      ...
      {/* sessa 2*/}
 <div className="ss3 ">
        <div className="flex flex-row justify-between max-w-6xl mx-auto py-16">
       
          <div className=" flex flex-col basis-6/12  mt-12 ">
            <h5 className="font-semibold font-uppcase text-white">
            Execution
            </h5>
            <h2 className=" font-extralight font-normal text-white">
            Detailed Services <br/>focused on high<br/> performing electronic<br/> trading
            </h2>
            <br/>
            <h5 className=" pt-16 text-left  text-white">
            Our dedicated team does a
proactive, careful and highquality<br/>
real-time monitoring
and can help tailor made the
best<br/> trading solution for your
needs:
            </h5>
          </div>
          <div className=" flex flex-col basis-6/12  mt-12 ">
 ...
 <div className="ss4-S ">
        <div className="flex flex-row justify-between max-w-6xl mx-auto py-16">
          ...
          <div className=" flex flex-col basis-6/12  mt-12 ">
            <h5 className="font-semibold font-uppcase">
            Post trade
            </h5>
            <h2 className=" font-extralight font-normal ">
            Detailed Services<br/>  focused on high <br/> performing <br/> electronic trading
            </h2>
            <br/>
            <h5 className=" pt-16 text-left capaapp">
            Besides all services provided by
our efficient middle and<br/> 
backoffice teams, Nova Futura tech
teams can also offer<br/> 
